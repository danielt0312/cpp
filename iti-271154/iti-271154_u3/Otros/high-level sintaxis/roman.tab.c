...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* results: number  */
#line 29 "roman.y"
         { fprintf(yyout, "%d\n", yyvsp[0]); }
#line 1066 "roman.tab.c"
    break;

  case 3: /* number: number NUM  */
#line 41 "roman.y"
             { yyval = yyvsp[-1] + yyvsp[0]; }
#line 1072 "roman.tab.c"
    break;


#line 1076 "roman.tab.c"
