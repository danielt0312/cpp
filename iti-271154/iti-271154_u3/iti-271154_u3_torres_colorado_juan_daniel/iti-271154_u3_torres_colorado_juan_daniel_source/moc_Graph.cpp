...
QT_MOC_LITERAL(1, 6, 15), // "bipartiteResult"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 11), // "isBipartite"
QT_MOC_LITERAL(4, 35, 11) // "advertencia"

    },
    "Graph\0bipartiteResult\0\0isBipartite\0"
    "advertencia"
};
...
void Graph::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->bipartiteResult((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->advertencia(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Graph::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Graph::bipartiteResult)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Graph::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Graph::advertencia)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Graph::bipartiteResult(bool _t1)
{
