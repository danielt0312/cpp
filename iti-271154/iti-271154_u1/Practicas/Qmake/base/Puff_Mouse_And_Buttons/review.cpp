...
/*    auto *title = new QLabel("Title:", this);
    ...
    auto *boton2 = new QPushButton ("Radio", this);
...
//  Lineas Nuevas (Incluyendo las clases Puff and Mouse trabajadas en clase)
    ...
    connect(boton2, &QPushButton::clicked, this, &Review::cambiarRadio); 
}

void Review::cambiarRadio() {
    //std::cout <<"Disparado por el boton \n";
    //findDialog->show();
    findDialog->setString("");
