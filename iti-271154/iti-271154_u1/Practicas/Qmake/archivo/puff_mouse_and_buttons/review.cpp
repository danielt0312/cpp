...
/*    auto *title = new QLabel("Title:", this);
    ...
    auto *boton1 = new QPushButton ("Borrar", this);
    auto *boton2 = new QPushButton ("Funcion2", this);
    auto *boton3 = new QPushButton ("Guardar puntos", this);
    auto *boton4 = new QPushButton ("Cargar puntos", this);
...
//  Lineas Nuevas (Incluyendo las clases Puff and Mouse trabajadas en clase)
    ...
    connect(boton2, &QPushButton::clicked, this, &Review::az_aljo);
    connect(boton3, &QPushButton::clicked, this, &Review::guardadoPuntos);
    connect(boton4, &QPushButton::clicked, this, &Review::cargadoPuntos);
}

void Review::az_aljo() {
    cout<<"ES que me as klickedo, borrado"<< '\n';
    pm1->LimpiarPuntos();
...
void Review::guardadoPuntos() {
    cout<<"Guardando puntos"<< '\n';
    pm1->guardarPuntos();
}


void Review::cargadoPuntos() {
    cout<<"Cargado puntos"<< '\n';
    pm1->cargarPuntos();
}
